...
const RELEASES = [
    ...
    },
    {
        ...
        // things that actually changed instead.
        //
        // Was "Le profil et le fair play, repensés": a past-participle title
        // is the consultancy register CHANGELOG_GUIDE.md rules out, and the
        // same shape appeared three times in this one release.
        title_fr: 'Les cartons arrivent ⚡',
        title_en: 'Cards are here ⚡',
        title_es: 'Llegan las tarjetas ⚡',
        title_it: 'Arrivano i cartellini ⚡',
        body_fr: [
    ...
    },
    {
        ...
        published: true,
        // Live is named because it is the headline of 5.2.0. The old title
        // paired it with "des signalements plus justes", which judged our own
        // previous behaviour as less fair; the second half now names the
        // change instead of grading it.
        title_fr: 'Poteau Live, et un match à la fois 🔴',
        title_en: 'Poteau Live, and one game at a time 🔴',
        title_es: 'Poteau Live, y un partido a la vez 🔴',
        title_it: 'Poteau Live, e una partita alla volta 🔴',
        ...
        body_fr: [
            ...
            '',
            '⚖️ Les cartons comptent aussi sur les matchs presque complets',
            'On a vu passer des désinscriptions de dernière minute sur des matchs à un joueur près du complet. On trouvait que ça n\'allait pas assez loin. Ces désinscriptions comptent maintenant comme les autres.',
            '',
            '🚩 Signaler quelqu\'un et raconter ce qui s\'est passé',
        ...
        body_en: [
            ...
            '',
            '⚖️ Cards now count on almost full games',
            'We saw last-minute drop-outs on games that were one player short of full. We did not think that went far enough. Those drop-outs now count like the others.',
            '',
            '🚩 Report someone and say what happened',
        ...
        body_es: [
            ...
            '',
            '⚖️ Las tarjetas también cuentan en los partidos casi completos',
            'Vimos bajas de última hora en partidos a los que les faltaba un jugador para llenarse. Nos parecía que se quedaba corto. Esas bajas ahora cuentan como las demás.',
            '',
            '🚩 Reportar a alguien y contar qué pasó',
        ...
        body_it: [
            ...
            '',
            '⚖️ I cartellini contano anche sulle partite quasi complete',
            'Abbiamo visto disdette dell\'ultimo minuto su partite a cui mancava un giocatore. Ci sembrava che non bastasse. Ora quelle disdette contano come le altre.',
            '',
            '🚩 Segnalare qualcuno e raccontare cosa è successo',
            ...
            '',
            '💳 Quando viene addebitata la carta',
