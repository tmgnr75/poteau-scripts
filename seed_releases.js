...
const RELEASES = [
    ...
    },
    {
        ...
        body_fr: [
            ...
            '',
            '🃏 Ta carte de niveau, comme une carte de joueur',
            'Le test de niveau donnait une note et s’arrêtait là. Maintenant il en sort une carte : ta photo, ton poste, ta note, et le détail de ce qui a été mesuré. Au foot, tes six qualités. Au padel, les sept du jeu, du service au jeu au mur. Elle part en story ou en message, et elle dit qui l’a passé.',
            '',
        ...
        body_en: [
            ...
            '',
            '🃏 Your level card, like a player card',
            'The skill test gave you a rating and stopped there. Now it produces a card: your photo, your position, your rating, and everything it measured. Six attributes for football, the seven of the game for padel, from the serve to the wall. It goes out as a story or a message, and it says whose it is.',
            '',
        ...
        body_es: [
            ...
            '',
            '🃏 Tu carta de nivel, como una carta de jugador',
            'El test de nivel daba una nota y ahí se quedaba. Ahora sale una carta: tu foto, tu posición, tu nota y el detalle de lo que se midió. En fútbol, tus seis cualidades. En pádel, las siete del juego, del saque al juego con la pared. Se comparte en story o por mensaje, y dice de quién es.',
            '',
        ...
        body_it: [
            ...
            '',
            '🃏 La tua carta livello, come una carta giocatore',
            'Il test del livello dava un voto e si fermava lì. Adesso ne esce una carta: la tua foto, il tuo ruolo, il tuo voto e il dettaglio di ciò che è stato misurato. Nel calcio, le tue sei qualità. Nel padel, le sette del gioco, dal servizio al gioco sul muro. Va in storia o in messaggio, e dice di chi è.',
            '',
