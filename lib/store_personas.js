...
/**
 * Invitation kickoffs, deliberately OFF the main slate.
 *
 * The invitations render on Home next to the list, and two cards showing the
 * same time reads as duplicated data rather than a busy evening.
 */
const INVITE_SLOTS = [
    [19, 15],
    [20, 45],
...
/** The invitation slate, built the same way as the evening one. */
function inviteSlate(base) {
    return INVITE_SLOTS.map(([h, m]) => {
...
module.exports = { PERSONAS, EVENING_SLOTS, INVITE_SLOTS, eveningSlate, inviteSlate };
