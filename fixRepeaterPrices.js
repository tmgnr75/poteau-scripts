...
async function fixRepeaterPrices() {
  try {
    ...
    querySnapshot.forEach((doc) => {
      batch.update(doc.ref, {
        priceUndiscounted: 10
//         description: `⚽ $3 Pickup at Soctainer? Say Less. 🔥
...
// Pull up, play for just $3, and run it back: it's our treat.
