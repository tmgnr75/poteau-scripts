...
Generated: 12/13/2025, 12:35:39 PM
...
**Coverage:** 100% (937/938 keys complete)
...
## ⚠️ Possible Copy-Paste Errors (11 keys)
...
## ⚠️ Leading/Trailing Space Issues (8 keys)
...
- [ ] Fix 1 missing translations (see table above)
- [ ] Fix 11 copy-paste errors (see table above)
- [ ] Fix 8 space issues (see table above)
...
| Complete (all 4 languages) | 937 (100%) |
...
|----------|--------|-------|----------|
| French (fr) | 938 | 0 | 100% |
| English (en) | 937 | 1 | 100% |
| Spanish (es) | 937 | 1 | 100% |
| Italian (it) | 937 | 1 | 100% |
...
**Screens with issues:** 1  
**Clean screens:** 51

### GameSheet

- **Path:** `/game/:gameId`
- **Translations:** 111 complete, 1 incomplete
...
| ✅ | 12 | `b0wzce2j` | Oui, je l\ | Yes, I reserved it | Sí, ya lo he reservado | Sì, l\ |
| ✅ | 13 | `hg6geiee` | Non, pas encore | No, not yet | No, aún no | No, non ancora |
| ✅ | 14 | `tdg3w2rs` | Oui, je l\ | Yes, I reserved it | Sí, ya lo he reservado | Sì, l\ |
| ✅ | 15 | `rj0cxne2` | Non, pas encore | No, not yet | No, aún no | No, non ancora |
| ✅ | 16 | `6l2hxaji` | Oui, je l\ | Yes, I reserved it | Sí, ya lo he reservado | Sì, l\ |
| ✅ | 17 | `zx6yjsz0` | Non, pas encore | No, not yet | No, aún no | No, non ancora |
| ✅ | 18 | `yh8q9i31` | Super ! C\ | Great! Is this a place wh | ¡Excelente! ¿Donde está l | Eccellente! Dove si trova |
...
| ✅ | 3 | `xx41c2t7` | Quel est ton surnom ? | What\ | ¿Cuál es tu verdadero nom | Qual è il tuo vero nome? |
...
| ✅ | 3 | `35zqwqpq` | Si tu as refusé l\ | If you denied access to y | Si ha rechazado el acceso | Se hai rifiutato l\ |
...
| ✅ | 6 | `3fbtz7di` | C\ | All good! | ¡Es bueno! | Va bene! |
| ✅ | 7 | `6g7dpxss` | On n\ | We couldn\ | No pudimos guardar la fot | Impossibile salvare la fo |
...
| ✅ | 3 | `hg3kzfmp` | Nous sommes désolés d\ | We are sorry to have made | Lamentamos haber tomado e | Siamo spiacenti di aver p |
| ✅ | 4 | `7eztsg0f` | Cette décision n\ | This decision is not yet  | Esta decisión aún no es d | Questa decisione non è an |
| ✅ | 5 | `b0947559` | Lorsque nous penserons qu | When we think you\ | Cuando creamos que ha ten | Quando riteniamo che tu a |
| ✅ | 6 | `9gx0otix` | L\ | The Poteau team | El equipo Poteau | La squadra di Poteau |
...
| Status | # | Key | 🇫🇷 French | 🇬🇧 English | 🇪🇸 Spanish | 🇮🇹 Italian |
|--------|---|-----|-----------|------------|------------|------------|
| ✅ | 1 | `x32dawoy` | C\ | It\ | Es tu partido. Elige quié | È la tua partita. Scegli  |
...
| ✅ | 37 | `s6xib0iq` | Pour plus d\ | For more info, you can ch | Para más información pued | Per ulteriori informazion |
| ✅ | 38 | `l2qhn6qu` | Notre politique de confid | Our privacy policy | Nuestra política de priva | La nostra politica sulla  |
| ✅ | 39 | `w46wxtx7` | Nos conditions d\ | Our terms of use | Nuestros términos de uso | Le nostre condizioni d\ |
...
| ✅ | 2 | `39p80bof` | Envoyer mon lien d\ | Send my invitation link | Enviar mi enlace de invit | Invia il mio link d\ |
...
| ✅ | 5 | `a71i64f9` | L\ | Preview of your invitatio | La vista previa de tu inv | L\ |
| ✅ | 6 | `1ssngfzn` |  t\ |  invites you to join thei |  te invita a unirte a su  |  ti invita a unirti al su |
...
| ✅ | 4 | `4l532nl9` | et jusqu\ | and up to...? | ¿y hasta…? | e fino a…? |
...
| ✅ | 2 | `iiq8q3wr` | Vérifie que tu as bien pa | Make sure you\ | Asegúrate de haber dado a | Assicurati di aver condiv |
...
| ✅ | 2 | `n1kagigp` | J\ | I already have a Poteau a | Ya tengo una cuenta Potea | Ho già un account Poteau |
| ✅ | 3 | `39pzrb46` | Entre ton adresse mail | Enter your email address | Introduce tu dirección de | Inserisci il tuo indirizz |
| ✅ | 4 | `738auohw` | Cette adresse n\ | This address is not accep | Esta dirección no es acep | Questo indirizzo non è ac |
...
| ✅ | 3 | `xkygbmox` | Ce n\ | This is just the beginnin | Este es solo el comienzo. | Questo è solo l\ |
...
| ✅ | 2 | `lfiodv6n` | C\ | What kind of game is it? | ¿Qué tipo de partido es? | Che tipo di partita è? |
| ✅ | 3 | `0bep8m0r` | Pour l\ | For now, you want your so | Por ahora, quieres que tu | Per ora, vuoi che il tuo  |
| ✅ | 4 | `avvle7zg` | Pour l\ | For now, you want your pa | Por ahora, quieres que tu | Per ora, vuoi che il tuo  |
| ✅ | 5 | `dsoqvc3r` | Pour l\ | For now, you want your ga | Por ahora, quieres que tu | Per ora, vuoi che la tua  |
| ✅ | 6 | `t301d7dg` | 🔗 | 🔗 | 🔗 | 🔗 |
...
| ✅ | 3 | `7gt2pv0d` | Et c\ | And what\ | ¿Y qué es lo más importan | E qual è la cosa più impo |
| ✅ | 4 | `qlc6dmzh` | S\ | Have fun | Disfrutar | Divertirsi |
| ✅ | 5 | `s30adgwe` | Tout gagner | Win everything | Ganarlo todo | Vincere tutto |
| ✅ | 6 | `wgfcwe0j` | S\ | Have fun | Disfrutar | Divertirsi |
| ✅ | 7 | `ivtavqrp` | Tout gagner | Win everything | Ganarlo todo | Vincere tutto |
| ✅ | 8 | `n5p1ry81` | S\ | Have fun | Disfrutar | Divertirsi |
...
| ✅ | 2 | `6a60nhl1` | L\ | Time | Tiempo | Tempo |
| ✅ | 3 | `12sgod2i` | 1 | 1 | 1 | 1 |
| ✅ | 4 | `epbogf0t` | 2 | 2 | 2 | 2 |
| ✅ | 5 | `95bj049t` | 3 | 3 | 3 | 3 |
| ✅ | 6 | `w5hvxyp7` | 4 | 4 | 4 | 4 |
...
| ✅ | 88 | `o1v3iu4a` | Valider | Validate | Valider | Convalidare |
...
| ✅ | 4 | `sruxgqa1` | Ce numéro n\ | This number is not valid. | Este número no es válido. | Questo numero non è valid |
...
| ✅ | 5 | `3fbtz7di` | C\ | All good! | ¡Es bueno! | Va bene! |
| ✅ | 6 | `6g7dpxss` | On n\ | We couldn\ | No pudimos guardar la fot | Impossibile salvare la fo |
...
| ✅ | 4 | `jiec3rzu` | OK, c\ | OK, what\ | ¿Cuál es el precio por pe | Qual è il prezzo a person |
...
| ✅ | 4 | `c6fsht1o` | L\ | Preview of your invitatio | La vista previa de tu inv | L\ |
| ✅ | 5 | `pgl2yr3y` |  t\ |  invites you to join thei |  te invita a unirte a su  |  ti invita a unirti al su |
...
| ✅ | 3 | `wi25w0vy` | Ton club (pro) n\ | Your club (pro) isn\ | ¿Tu club (profesional) no | Il tuo club (pro) non è n |
...
| Status | # | Key | 🇫🇷 French | 🇬🇧 English | 🇪🇸 Spanish | 🇮🇹 Italian |
|--------|---|-----|-----------|------------|------------|------------|
| ✅ | 1 | `6o7hqosb` | Ton match a l\ | Your game seems to have g | ¡Parece que tu partido sa | Sembra che la tua partita |
...
| ✅ | 6 | `iht7wam7` | ) | ) | ) | ) |
| ✅ | 7 | `t2dizl3s` | C\ | Is it a weekly game? | ¿Es un partido semanal? | È una partita settimanale |
...
| ✅ | 15 | `dgkyral9` | Ouvrir l\ | Open access | Abrir el acceso | Apri l\ |
...
| ✅ | 23 | `1ddd2aqn` |   |   |   |   |
| ✅ | 24 | `ufqvb3hj` | s\ | has registered. | registrado. | registrato. |
...
| ✅ | 28 | `yddetl4p` | Ouais c\ | Yeah, it\ | si, es bueno para mi | Sì, mi fa bene |
| ✅ | 29 | `139ueuu0` | Sadio Mané | Sadio Mané | Sadio Mané | Sadio Manè |
| ✅ | 30 | `hieh66sh` | Ouais c\ | Yeah, it\ | si, es bueno para mi | Sì, mi fa bene |
...
| ✅ | 37 | `whsppjk0` | Il n\ | There are no bad question | No hay preguntas malas: i | Non ci sono domande sbagl |
| ✅ | 38 | `cbiuf24k` | Plus d\ | More info on the game | Más info sobre el partido | Più info sulla partita |
| ✅ | 39 | `7fs24xzg` | 🌍 | 🌍 | 🌍 | 🌍 |
...
| ✅ | 50 | `doyhb224` | L’accès s’ouvrira à tout  | Access will open to every | El acceso se abrirá para  | L\ |
...
| ✅ | 54 | `32rgxhnk` | Ouvrir l\ | Open access to my game | Abrir el acceso a mi part | Aprire l\ |
| ✅ | 55 | `tckcbt9i` | Tu peux choisir de l\ | You can choose to open it | Puedes elegir abrirlo a t | Puoi scegliere di aprirlo |
| ✅ | 56 | `ti91u5a7` | En savoir plus | Learn more | Únete a la comunidad | Unisciti alla comunità |
| ✅ | 57 | `4lanklkj` | N\ | Anyone can join | Cualquiera puede unirse | Chiunque può unirsi |
...
| ✅ | 69 | `z04iuoct` | Sur l\ | On the app | En la aplicación | Sull\ |
...
| ✅ | 83 | `5ap5iez0` | Plus d\ | More info on  | Más información sobre  | Più info su  |
...
| ✅ | 91 | `2ufm658b` | Plus d\ | More info on  | Más información sobre  | Più info su  |
...
| ⚠️ | 97 | `mbzjn5pj` | , tu peux jouer pour  | ❌ | ❌ | ❌ |
| ✅ | 98 | `qy8acynx` | . | . | . | . |
| ✅ | 99 | `xozhjpu7` | L\ | The Poteau app lets you s | La app de Poteau te muest | L’app Poteau ti mostra tu |
| ✅ | 100 | `chxk5h16` | 👉 Plus d\ | 👉 More info on  | 👉 Más información sobre  | 👉 Maggiori informazioni  |
| ✅ | 101 | `8xd713uj` | poteau-app.com | poteau-app.com | poteau-app.com | poteau-app.com |
| ✅ | 102 | `u1zkt0oi` | Rendez-vous sur l\ | Go to the Poteau app to j | Mira la app de Poteau par | Guarda l’app Poteau per t |
| ✅ | 103 | `zkd0grdg` | Ouvrir dans l\ | Open in the app | Abrir en la app | Apri nell’app |
| ✅ | 104 | `dx2n6amq` | Télécharger | Download | Descarga la aplicación | Scarica l\ |
...
| ✅ | 107 | `rhy4kd93` | Plus qu\ | Only one player to find | Último lugar disponible � | Ultimo posto disponibile  |
...
| ✅ | 3 | `vv1k6ny6` | Voir l\ | View the app | Ver la aplicación | Visualizza l\ |
...
| Status | # | Key | 🇫🇷 French | 🇬🇧 English | 🇪🇸 Spanish | 🇮🇹 Italian |
|--------|---|-----|-----------|------------|------------|------------|
| ✅ | 1 | `5618031b` | PADEL | PADEL | PADEL | PADEL |
...
| Status | # | Key | 🇫🇷 French | 🇬🇧 English | 🇪🇸 Spanish | 🇮🇹 Italian |
|--------|---|-----|-----------|------------|------------|------------|
| ✅ | 1 | `3gb450zm` | PADEL | PADEL | PADEL | PADEL |
...
| ✅ | 6 | `s5l57qp3` | PADEL | PADEL | PADEL | PADEL |
...
| Status | # | Key | 🇫🇷 French | 🇬🇧 English | 🇪🇸 Spanish | 🇮🇹 Italian |
|--------|---|-----|-----------|------------|------------|------------|
| ✅ | 1 | `jokud392` | PADEL | PADEL | PADEL | PADEL |
...
| ✅ | 6 | `08sxviwc` | Ça y est !  | That\ | ¡Eso es!  | Ecco fatto!   |
...
| ✅ | 5 | `niar68zc` | PADEL | PADEL | PADEL | PADEL |
| ✅ | 6 | `hv2f2d5c` | joue pour | plays for | juega para | gioca per |
| ✅ | 7 | `pu8t4dyn` | S\ | Have fun | Disfrutar | Divertirsi |
...
| ✅ | 14 | `3fbtz7di` | C\ | All good! | ¡Es bueno! | Va bene! |
| ✅ | 15 | `6g7dpxss` | On n\ | We couldn\ | No pudimos guardar la fot | Impossibile salvare la fo |
...
| ✅ | 7 | `8q0qebe0` | S\ | Have fun | Disfrutar | Divertirsi |
...
| ✅ | 11 | `3fbtz7di` | C\ | All good! | ¡Es bueno! | Va bene! |
| ✅ | 12 | `6g7dpxss` | On n\ | We couldn\ | No pudimos guardar la fot | Impossibile salvare la fo |
...
| ✅ | 19 | `bov2i1ns` | 🌍 | 🌍 | 🌍 | 🌍 |
| ✅ | 20 | `xsawsbrm` | Tu ne veux plus que l\ | Don\ | ¿Ya no quieres que la app | Non vuoi più che l\ |
| ✅ | 21 | `n6bfbi9w` | 🇫🇷 | 🇫🇷 | 🇫🇷 | 🇫🇷 |
| ✅ | 22 | `9z2gjdak` | 🇺🇸 | 🇺🇸 | 🇺🇸 | 🇺🇸 |
| ✅ | 23 | `zcmo33nq` | 🇪🇸 | 🇪🇸 | 🇪🇸 | 🇪🇸 |
| ✅ | 24 | `2mdncldz` | 🇮🇹 | 🇮🇹 | 🇮🇹 | 🇮🇹 |
...
| ✅ | 34 | `auz85449` | Besoin d\ | Need help? | ¿Necesitas ayuda? | Hai bisogno di aiuto? |
...
| ✅ | 41 | `avomicxc` | 💬 | 💬 | 💬 | 💬 |
| ✅ | 42 | `jkv3j6t8` | Il y a un problème que tu | Is there a problem you\ | ¿Hay un problema que está | C\ |
...
| ✅ | 47 | `i396d6vx` | Lire la politique de conf | Read the privacy policy | Leer la política de priva | Leggi l\ |
